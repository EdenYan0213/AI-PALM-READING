...
public class UserTokenService {
  ...
  public com.palmistrylab.api.model.ApiDtos.UserIdentityResponse resolveIdentity(String previous) {
    boolean restored = previous != null && !previous.isBlank() && verifyUserId(previous);
    return new com.palmistrylab.api.model.ApiDtos.UserIdentityResponse(resolveUserId(previous), restored);
  }
